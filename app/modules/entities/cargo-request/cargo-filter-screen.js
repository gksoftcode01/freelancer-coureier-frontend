...
function CargoFilterScreen(props) {
 ...
 const isBidSentRef = createRef();

 const formValueToEntity = (value) => {
    const entity = { 
     isMine : value.isMine  ?? false,
     isBidSent : value.isBidSent ?? false,
   };
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    flightFilter:(filterentity)=> dispatch(CargoRequestActions.flightFilter(filterentity)),

  };
};

export default connect(mapStateToProps, mapDispatchToProps)(CargoFilterScreen);
